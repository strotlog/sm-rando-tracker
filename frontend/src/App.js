...
// const webSocketLocation = 'wss://sm-rando-tracker-backend.herokuapp.com'
    ...
    <div>
      <fieldset>
        ...
        <div className="instructions">
          Enter your tracker key above, click connect.<br />
          Add a website capture to your restream, one per runner.  You can use the links per player to get a version that is just the inventory<br />
          send the url of the tracker (including the ?trackerKey parameter) to your loyal trackers<br />
          any changes they make should be reflected in your restreamed tracker(s)<br />
          </div>
      </fieldset>
    </div>
  );
